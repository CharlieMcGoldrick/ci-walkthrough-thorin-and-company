    ...
    with open("data/company.json", "r") as json_data:
        ...
        for obj in data:
            if obj["url"] == member_name:
                member = obj
    # The first member is the member variable being passed through into our HTML file
    # The second member is the member object that was created above 
...
def contact():
    if request.method == "POST":
        flash("Thanks {}, we have received your messagge!".format(
